...
# INIT_ORIENTATION = (0, 0, -0.819, 0.574)
...
RL_TORQUE_LIMITS = 1.0 * TORQUE_LIMITS
...
STD_COEFF = 0.01
HEIGHT_NOISE = HEIGHT_HIGH * STD_COEFF * 0.8
VEL_LIN_NOISE = VEL_LIN_HIGH * STD_COEFF * 0.8
...
JOINT_ANGLES_NOISE = np.maximum(abs(JOINT_ANGLES_HIGH), abs(JOINT_ANGLES_LOW)) * STD_COEFF * 0.1
JOINT_VELOCITIES_NOISE = JOINT_VELOCITIES_HIGH * STD_COEFF * 0.6
...
PITCH_NOISE = PITCH_HIGH * STD_COEFF * 0.9
