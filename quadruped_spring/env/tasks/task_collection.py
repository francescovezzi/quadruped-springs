...
class TaskCollection(CollectionBase):
    ...
    def __init__(self):
        ...
        self._dict = {"JUMPING_ON_PLACE_HEIGHT": self.JUMPING_ON_PLACE_HEIGHT, "JUMPING_FORWARD": self.JUMPING_FORWARD, "JUMPING_IN_PLACE_DENSE": self.JUMPING_IN_PLACE_DENSE}
